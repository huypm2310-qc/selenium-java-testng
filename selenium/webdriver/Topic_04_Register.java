...
public class Topic_04_Register {
    ...
    public void Register_03_Incorrect_Confirm_Email(){
        driver.get("https://alada.vn/tai-khoan/dang-ky.html");
        driver.findElement(By.id("txtFirstname")).sendKeys("John Kenedy");
        driver.findElement(By.id("txtEmail")).sendKeys("abcdef@gmail.com");
        driver.findElement(By.id("txtCEmail")).sendKeys("abcdef@gmail.net");
        driver.findElement(By.id("txtPassword")).sendKeys("123456");
        driver.findElement(By.id("txtCPassword")).sendKeys("123456");
        driver.findElement(By.id("txtPhone")).sendKeys("0987654321");
    ...
    public void Register_04_Invalid_Password(){
        ...
        driver.findElement(By.id("txtFirstname")).sendKeys("John Kenedy");
        driver.findElement(By.id("txtEmail")).sendKeys("abcdef@gmail.com");
        driver.findElement(By.id("txtCEmail")).sendKeys("abcdef@gmail.com");
        driver.findElement(By.id("txtPassword")).sendKeys("12356");
        driver.findElement(By.id("txtCPassword")).sendKeys("12356");
        driver.findElement(By.id("txtPhone")).sendKeys("0987654321");
    ...
    public void Register_06_Invalid_Phone_Number(){
        ...
        // Case 2 - More than 11 characters
        driver.findElement(By.id("txtPhone")).clear();
        driver.findElement(By.id("txtPhone")).sendKeys("098765432112345");
        ...
        // Case 3 - Content , text
        driver.findElement(By.id("txtPhone")).clear();
        driver.findElement(By.id("txtPhone")).sendKeys("09876543e1");
